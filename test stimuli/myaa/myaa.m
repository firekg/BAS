...
w = warning;
warning off;
if strcmp(self.aamethod,'standard') || strcmp(self.aamethod,'noshrink') || strcmp(self.aamethod,'update')
    ...
    if strcmp(self.aamethod,'standard') || strcmp(self.aamethod,'update')
